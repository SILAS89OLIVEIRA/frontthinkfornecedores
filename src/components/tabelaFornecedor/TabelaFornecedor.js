...
import { Table, FormGroup, Label, Button, Input } from 'reactstrap';
                            ...
                            <div>
                                <StickyTable className="Tabela1" >
                                    ...
                                    {vendeestgeral.map((vendeestgeral, idx) => (
                                        <Row key={idx} vendeestgeral={vendeestgeral} className="cabecalho2">
                                ...
                                <div className="Tabela2">
                                    <StickyTable>
                                        ...
                                        {vendeestgeralteste.map((vendeestgeralteste, idx) => (
                                            <Row key={idx} vendeestgeral={vendeestgeralteste} className="cabecalho2">
                                    ...
                                    <div >
                                        <StickyTable className='Tabela3' >
                                            ...
                                            {vendeestgeralitem.map((vendeestgeralitem, idx) => (
                                                <Row key={idx} vendeestgeralitem={vendeestgeralitem} className="cabecalho2">
                                ...
                                <div>
                                    <StickyTable className='Tabela4'>
                                        ...
                                        {vendeestgeralitemtam.map((vendeestgeralitemtam, idx) => (
                                            <Row key={idx} vendeestgeralitemtam={vendeestgeralitemtam} className="cabecalho2">
                                ...
                                <div>
                                    <StickyTable className="Tabela5">
                                        ...
                                        {vendeestgeralitemloja.map((vendeestgeralitemloja, idx) => (
                                            <Row key={idx} vendeestgeralitemloja={vendeestgeralitemloja} className="cabecalho2">
                                ...
                                <div>
                                    <StickyTable className='Tabela6'>
                                        ...
                                        {vendeestgeralacumloja.map((vendeestgeralacumloja, idx) => (
                                            <Row key={idx} vendeestgeralacumloja={vendeestgeralacumloja} className="cabecalho2">
                                ...
                                <div >
                                    <StickyTable className='Tabela7'>
                                        ...
                                        {vendeestgeralacumlojaloja.map((vendeestgeralacumlojaloja, idx) => (
                                            <Row key={idx} vendeestgeralacumlojaloja={vendeestgeralacumlojaloja} className="cabecalho2">
                                ...
                                <div>
                                    <StickyTable className='Tabela8'>
                                        ...
                                        {vendeestgeralacumlojalojaloja.map((vendeestgeralacumlojalojaloja, idx) => (
                                            <Row key={idx} vendeestgeralacumlojalojaloja={vendeestgeralacumlojalojaloja} className="cabecalho2">
                                ...
                                <div >
                                    <StickyTable className='Tabela'>
                                        ...
                                        {vendeestgeralacumloja4.map((vendeestgeralacumloja4, idx) => (
                                            <Row key={idx} vendeestgeralacumloja4={vendeestgeralacumloja4} className="cabecalho2">
                                ...
                                <div >
                                    <StickyTable className='Tabela'>
                                        ...
                                        {todositensporcodigoloja.map((todositensporcodigoloja, idx) => (
                                            <Row key={idx} todositensporcodigoloja={todositensporcodigoloja} className="cabecalho2">
                                ...
                                <div>
                                    <StickyTable className='Tabela'>
                                        ...
                                        {consultaconso.map((consultaconso, idx) => (
                                            <Row key={idx} consultaconso={consultaconso} className="cabecalho2">
