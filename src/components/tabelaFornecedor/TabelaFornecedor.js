...
const TabelaFornecedor = (props) => {
   ...
   // console.log( [datainicial, datafinal, value])
    ...
    return ( 
        <div >  <center className="centrocentro">   
    ...
    <div id='pai'>
        <div id='div1' className="hide">
            ...
            <Button className = "buttonImprimir" sm={12} onClick={PDF1}> Imprimir </Button> 
...
<Col sm={2} md={6} lg={6} xl={6}>
                        <FormGroup className="revista">
                            <Label for="revista" className="revista">Código</Label>
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir"  sm={12} onClick={PDF2}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio2"
    ...
    <div id='div3' className="hide">
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF3}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio3"
    ...
    <div id='div4' className="hide">
                 ...
                 <Col sm={2} md={6} lg={6} xl={6}>
                 <Label for="revista" className="revista">Referência</Label>
                 <Input type='text' name='codigopro' onChange = { onChange4 }  placeholder="Código Produto"/>
                 </Col>
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF4}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio4"
          ...
          <div id='div5' className="hide">
             ...
             <Col sm={2} md={6} lg={6} xl={6}>
                 ...
                 <Input type='text' name='codigopro' onChange = { onChange4 } placeholder="Código Produto"/>
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF5}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio5"
          ...
          <div id='div6' className="hide">
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF6}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio6"
          ...
          <div id='div7' className="hide">
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>
                        <FormGroup className="revista">
                            <Label for="revista" className="revista">Loja</Label>
                            <Input type="select" id="revista"  onChange={onChange5}>
                                <option value='0'>SELECIONE OPÇÃO</option>
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF7}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio7"
          ...
          <div id='div8' className="hide">
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF8}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio8"
          ...
          <div id='div9' className="hide">
                 ...
                 <Col sm={2} md={6} lg={6} xl={6} >
                 <Label for="revista" className="revista">Referência</Label>
                 <Input className="enter" type='text' name='produtos_reffor' onChange = { onChange4 } placeholder="Referência" />
                 </Col>
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF9}> Imprimir </Button> 
          ...
          <div id='div10' className="hide">
                  ...
                  <Col sm={2} md={6} lg={6} xl={6}>  
            <FormGroup className="group-buttons-imprimir">
            <Button className = "buttonImprimir" sm={12} onClick={PDF10}> Imprimir </Button> 
            <ReactHTMLTableToExcel
                    id="test-table-xls-button"
                    className="download-table-xls-button"
                    table="relatorio10"
